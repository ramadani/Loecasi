...
import org.loecasi.android.feature.gift.create.GiftCreateScreenModule
...
abstract class ActivityBuilder {
    ...
    @ContributesAndroidInjector(modules = arrayOf(GiftCreateScreenModule::class))
    abstract fun bindGiftCreateActivity(): GiftCreateActivity
}
